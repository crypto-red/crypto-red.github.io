...
function account_backup_qr_code_image(text_string, size_px = 512, level="M", name = "name", account_name="account_name") {
...
module.exports = {
    account_backup_qr_code_image: account_backup_qr_code_image,
};