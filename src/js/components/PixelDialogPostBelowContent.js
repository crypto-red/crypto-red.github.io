        ...
        return (
            <div className={classname} style={{
                ...
                <div style={{contentVisibility: will_change ? "auto": h_svg ? "visible": "hidden", position: "relative", height: "100%"}}>
                    <div style={{transition: "background-image .1s linear 0s", position: "relative", height: "100%", mixBlendMode: "multiply", backgroundBlendMode: "color-burn", ...color_box_shadows}}>
                        ...
                        <div style={{contain: "paint", position: "absolute", width: "100%", height: "100%", top: 0, left: 0, willChange: "contents"}}>
                            <img src={sc_svg} style={{transition: "transform .1s linear 0s", filter: "opacity(0.5)",  zIndex: 14, position: "absolute", bottom: "50%", right: "50%", width: "100%", height: "100%", transform: `translate(calc(50% + ${(px*20-100)*pz}px), calc(50% + ${(py*20-100)*pz}px))`}}/>
                            <img src={ss_svg} style={{transition: "transform .1s linear 0s", zIndex: 14, position: "absolute", bottom: 64, left: 64, width: 32, height: 168, transform: `translate(${(px*5-25)*pz}px, ${(py*5-20)*pz}px)`}}/>
                            <img src={sg_svg} style={{transition: "transform .1s linear 0s", zIndex: 14, position: "absolute", top: 372, right: 372, width: 372, height: 372, transformOrigin: "top right", transform: `translate(${(px*10-50)*pz}px, ${(py*10-50)*pz}px)`}}/>
                            <img src={st_svg} style={{transition: "transform .1s linear 0s", zIndex: 14, position: "absolute", bottom: 256, right: 256, width: 336, height: 336, transformOrigin: "middle center", transform: `translate(${(px*15-75)*pz}px, ${(py*15-75)*pz}px)`}}/>
                        </div>
