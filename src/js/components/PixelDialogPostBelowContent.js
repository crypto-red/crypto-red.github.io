            ...
            <div className={classname} style={{
                ...
                <div style={{contentVisibility: will_change ? "auto": h_svg ? "visible": "hidden", position: "relative", height: "100%"}}>
                    <div style={{transition: "background-color 360ms ease-in 0s", position: "relative", height: "100%", backgroundBlendMode: "color-burn", ...color_box_shadows}}>
                        ...
                        <span style={{filter: "opacity(0.3)", position: "absolute", bottom: "50%", right: 32, width: "66%", color, fontFamily: `"Special Elite"`}}>
                            ...
                            <br />
                            <span>Our far efforts has been to not withdraw from our positions at the near cost of life sometimes, the black ops "operation" (decentralize everything) from around 2014 seduced our hacker mindset, letting us to empower our love for truly awesome systems hacking and development empowering: autonomous, self-good-willing "secret community agents" in order to negate the opportunity for "them, who stands against us" to act.</span>
                        </span>
                    </div>
