        ...
        return (
            <Dialog open={open}
                ...
                <DialogContent>
                    ...
                    <p>They not only want to deny art but as the global delusional / delirious state of mind is spreading more and more in the real world with the "metaverse" social construct we also say it widely and openly to achieve it together, improvements in information technology , (as in other words, computer science, that is to say the fun fact of: "<span className={"highlighted"}>making the metaverse and daily life a creative experience, continually original-delusional-ecstatic</span>"), is a difficult process and a powerful thing.</p>
