            ...
            <div>
                ...
                <Dialog open={_is_dialog_info_open} onClose={this._handle_dialog_info_close}>
                    <DialogContent>
                        ...
                        <p>Now in a broader way, we said that our future will be the creation and collection of situations, maybe situations for nothing or nothingness with ease... situation they wanted and they maybe wanted to devaluate everything which was a part of the modern society but for sure for them art market, art dealing with art, or something that should be ruined to be believed by the people is a threat.</p>
                        <p>They want to not only negate art but as the more global delirious state of mind flow into existence, we broadly put it also to realize, that in other terms, IT (information technology), which is to say make of daily life a creative, continuously-original-delirious-ecstatic experience, is a difficult process. Throughout the best efforts of our developers,</p>
